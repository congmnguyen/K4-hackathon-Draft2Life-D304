...
- **24/30 case đạt = 80.0%**
- D2 (không bịa nguồn): **30/30** — không case nào bịa phòng
...
| N03 | thường | Cho tôi cửa sổ 1m5 ở tường phía đông phòng họp | apply | clarify | ❌ | ✅ | ❌ | ❌ | route: chờ apply nhận clarify · width_m: chờ 1.5 nhận None |
| N04 | thường | thêm cửa sổ rộng 1,2 m ở tường nam phòng khách | apply | clarify | ❌ | ✅ | ❌ | ❌ | route: chờ apply nhận clarify · side: chờ 'S' nhận None |
| N05 | thường | làm ơn thêm cửa đi 1m ở tường tây khu làm việc | apply | clarify | ❌ | ✅ | ❌ | ❌ | route: chờ apply nhận clarify · width_m: chờ 1.0 nhận None |
...
| L1-04 | ① nguồn sự thật | tầng 2 thêm giúp tôi một ô thông tầng | no_evidence | out_of_scope | ❌ | ✅ | ✅ | ❌ | route: chờ no_evidence nhận out_of_scope |
...
| L2-04 | ② mơ hồ | thêm cửa sổ rộng khoảng chừng hơn một mét ở phòng khách | clarify | clarify | ✅ | ✅ | ✅ | ✅ | — |
...
| L4-01 | ④ đặc thù domain | thêm cửa đi rộng 0.4m ở tường phía bắc phòng ngủ | apply | apply | ✅ | ✅ | ❌ | ❌ | guard KHÔNG chặn case đáng chặn |
...
| H01 | hiếm | ADD A WINDOW 1.2m ON THE WEST WALL OF THE LIVING ROOM | apply | clarify | ❌ | ✅ | ❌ | ❌ | route: chờ apply nhận clarify · width_m: chờ 1.2 nhận None |
